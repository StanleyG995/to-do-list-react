	...
	return (
		<TaskProvider>
			<div className='app-wrapper'>
				...
				<Modal children={<p>Test content.</p>} buttonPrimary={<Button children={<p>Primary action</p>} classes='button button--s button--primary' onClick={() => {console.log("I'm primary button!")}}/>}/>
			</div>
